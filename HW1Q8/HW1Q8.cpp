...
public:
    // Constructor
    Pilot(const std::string& pilotName, std::shared_ptr<Plane> planePtr) : name(pilotName), myPlane(planePtr) {
...
int main() {
    ...
    auto pilot1 = std::make_shared<Pilot>("Captain John", plane);
    auto pilot2 = std::make_shared<Pilot>("Co-Pilot Dave", plane);
